...
function displayFaviconfull_name() {
    const faviconElement = document.getElementById('full_name_verified_source_favicon');
    const linkElement = document.getElementById('full_name_verified_source_icon');
