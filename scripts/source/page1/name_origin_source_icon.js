...
function displayFaviconname_origin() {
    const faviconElement = document.getElementById('name_origin_verified_source_favicon');
    const linkElement = document.getElementById('name_origin_verified_source_icon');
