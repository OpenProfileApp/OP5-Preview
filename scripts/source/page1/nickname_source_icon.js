...
function displayFaviconnickname() {
    const faviconElement = document.getElementById('nickname_verified_source_favicon');
    const linkElement = document.getElementById('nickname_verified_source_icon');
