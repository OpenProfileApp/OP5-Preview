function updateVerifiedSourcePosition() {
    const firstNameGroup = document.getElementById('middle_name_label_tab');
    const firstNameVerifiedSourceGroup = document.getElementById('middle_name_verified_source_group');
