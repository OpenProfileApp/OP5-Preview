function updateVerifiedSourcePosition() {
    const firstNameGroup = document.getElementById('last_name_label_tab');
    const firstNameVerifiedSourceGroup = document.getElementById('last_name_verified_source_group');
