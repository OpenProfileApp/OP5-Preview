function updateVerifiedSourcePosition() {
    const firstNameGroup = document.getElementById('name_origin_label_tab');
    const firstNameVerifiedSourceGroup = document.getElementById('name_origin_verified_source_group');
