function updateVerifiedSourcePosition() {
    const firstNameGroup = document.getElementById('first_name_label_tab');
    const firstNameVerifiedSourceGroup = document.getElementById('first_name_verified_source_group');
