function updateVerifiedSourcePosition() {
    const firstNameGroup = document.getElementById('personal_thoughts_name_label_tab');
    const firstNameVerifiedSourceGroup = document.getElementById('personal_thoughts_name_verified_source_group');
