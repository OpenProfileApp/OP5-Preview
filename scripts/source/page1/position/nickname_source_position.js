function updateVerifiedSourcePosition() {
    const firstNameGroup = document.getElementById('nickname_label_tab');
    const firstNameVerifiedSourceGroup = document.getElementById('nickname_verified_source_group');
