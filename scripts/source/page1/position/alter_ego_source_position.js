function updateVerifiedSourcePosition() {
    const firstNameGroup = document.getElementById('alter_ego_label_tab');
    const firstNameVerifiedSourceGroup = document.getElementById('alter_ego_verified_source_group');
