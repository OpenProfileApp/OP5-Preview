function updateVerifiedSourcePosition() {
    const firstNameGroup = document.getElementById('full_name_label_tab');
    const firstNameVerifiedSourceGroup = document.getElementById('full_name_verified_source_group');
