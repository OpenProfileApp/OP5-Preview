...
function displayFaviconprefix() {
    const faviconElement = document.getElementById('prefix_verified_source_favicon');
    const linkElement = document.getElementById('prefix_verified_source_icon');
