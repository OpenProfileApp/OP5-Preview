...
function displayFaviconpersonal_thoughts_name() {
    const faviconElement = document.getElementById('personal_thoughts_name_verified_source_favicon');
    const linkElement = document.getElementById('personal_thoughts_name_verified_source_icon');
