...
function displayFaviconlast_name() {
    const faviconElement = document.getElementById('last_name_verified_source_favicon');
    const linkElement = document.getElementById('last_name_verified_source_icon');
