...
function displayFaviconformer_name() {
    const faviconElement = document.getElementById('former_name_verified_source_favicon');
    const linkElement = document.getElementById('former_name_verified_source_icon');
