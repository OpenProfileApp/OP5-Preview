...
function displayFaviconalias() {
    const faviconElement = document.getElementById('alias_verified_source_favicon');
    const linkElement = document.getElementById('alias_verified_source_icon');
