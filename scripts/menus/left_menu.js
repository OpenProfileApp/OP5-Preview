...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const toggle_left_menu_text = document.querySelector('#toggle_left_menu_text');
    ...
    toggle_left_menu.addEventListener('click', function () {
        if (left_inner.style.display === 'none') {
            ...
            toggle_left_menu_text.option = "option_1";
            toggle_left_menu_text.textContent = "Hide Menu"; // TEMP ONLY
        } else {
            left_inner.style.opacity = '1';
            left_inner.style.transform = "translateX(-280px)";
            center.style.left = "calc(50% + 100px)";
            left.style.borderRadius = "0px 25px 0px 0px";
            toggle_left_menu_text.option = "option_2";
            toggle_left_menu_text.textContent = "Show Menu"; // TEMP ONLY
            setTimeout(function () {
